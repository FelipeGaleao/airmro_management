...
```
docker run -p "3306:3306" -e "MYSQL_PASSWORD=airmro_management" -e "MYSQL_USER=airmro_management" -e "MYSQL_DATABASE=airmro_management" -e ALLOW_EMPTY_PASSWORD=yes bitnami/mysql:8.0.28
```
